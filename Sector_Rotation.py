...
if market == 'america':
    ...
    for idx, sector in enumerate(sectors):    
        ...
        day_50_ma_response = get_data_us(sector,day_50_suffix,n_months,frequencies[1],date)

        day_100_ma_response = get_data_us(sector,day_100_suffix,n_months,frequencies[1],date)
...
smooth_period_cycle_50_100_dict = {'Medium-term':10,'Long-term':10}
